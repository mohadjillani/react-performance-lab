...
| ---------------------------------- | -------------------------------------------: | -----------------------------------------: | ------------: | ------------------: |
| `main` `0b034b4`                   |               258.5 kB / 126.3 kB / 258.6 kB |                               94 / 55 / 94 |       1155 ms |                   3 |
| `fix/01-code-splitting` `76fdd1a`  |               152.7 kB / 126.4 kB / 127.6 kB |                               93 / 57 / 98 |       1152 ms |                   3 |
| `fix/02-dependency-diet` `875f0e9` |               114.3 kB / 107.6 kB / 108.8 kB |                               94 / 61 / 97 |        806 ms |                   3 |
| `fix/03-ssr-isr` `0b56e2c`         |               107.6 kB / 107.2 kB / 108.2 kB |                               99 / 95 / 97 |        126 ms |                   1 |
| `fix/04-query-caching` `848dd37`   |               107.6 kB / 107.6 kB / 120.7 kB |                               99 / 96 / 99 |        115 ms |                   0 |
| `fix/05-render-work` `c5b1abc`     |               112.8 kB / 120.6 kB / 120.7 kB |                               99 / 96 / 99 |         21 ms |                   0 |

_Generated by `npm run compare` on 2026-08-30 — local run, Apple Silicon, 8 GB, Node 23. Branches are cumulative, so each row is measured against the row above it, not against `main` ([ADR 001](docs/adr/001-cumulative-fix-branches.md)). Bundle sizes are gzip; Lighthouse figures are the median of three runs under mobile emulation with simulated throttling ([methodology](docs/methodology.md)). Full per-route tables: [docs/results.md](docs/results.md). The weekly [`compare`](.github/workflows/compare.yml) workflow re-measures every branch on GitHub Actions runners and reports the result in its job summary; it deliberately does not commit, so this table is always one a person put here on purpose._
