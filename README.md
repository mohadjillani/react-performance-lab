...
| ---------------------------------- | -------------------------------------------: | -----------------------------------------: | ------------: | ------------------: |
| `main` `2216e1a`                   |               258.3 kB / 126.3 kB / 258.4 kB |                               98 / 51 / 92 |       2053 ms |                   3 |
| `fix/01-code-splitting` `8da4dc1`  |               152.8 kB / 126.5 kB / 127.7 kB |                              100 / 57 / 99 |       1137 ms |                   3 |
| `fix/02-dependency-diet` `2466dc8` |               114.4 kB / 107.6 kB / 108.9 kB |                              100 / 61 / 99 |        848 ms |                   3 |
| `fix/03-ssr-isr` `78e7fb1`         |               107.6 kB / 107.3 kB / 108.2 kB |                               99 / 89 / 99 |        319 ms |                   1 |
| `fix/04-query-caching` `86f6090`   |               107.6 kB / 107.7 kB / 120.8 kB |                               99 / 83 / 99 |        497 ms |                   0 |
| `fix/05-render-work` `1c7de6f`     |               112.8 kB / 120.6 kB / 120.8 kB |                               98 / 97 / 98 |         52 ms |                   0 |

_Generated by `npm run compare` on 2026-09-07 — GitHub Actions, ubuntu-latest, run 2. Branches are cumulative, so each row is measured against the row above it, not against `main` ([ADR 001](docs/adr/001-cumulative-fix-branches.md)). Bundle sizes are gzip; Lighthouse figures are the median of three runs under mobile emulation with simulated throttling ([methodology](docs/methodology.md)). Full per-route tables: [docs/results.md](docs/results.md)._
